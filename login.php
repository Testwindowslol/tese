...
<div class="col-xs-4 text-center">
  <!-- onclick="showSwal('mixin')" -->
<button type="button" onclick="login()"  class="btn btn-effect-ripple btn-sm btn-primary">Let's Go<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span></button>
